          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                />
                <button className="px-2 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg font-medium transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 whitespace-nowrap">
