...
interface JEEPageProps {
  darkMode: boolean;
  setDarkMode: (value: boolean) => void;
}

const JEEPage: React.FC<JEEPageProps> = ({ darkMode, setDarkMode }) => {
  ...
  const fetchJEECourses = useCallback(async () => {
    ...
    try {
      ...
      // Filter by known JEE course IDs
      const filtered = allCourses.filter(course => 
        JEE_COURSE_IDS.includes(course.id)
      );
      
      console.log('Filtered JEE courses:', filtered);
      ...
      console.error('Failed to fetch JEE courses:', error);
    } finally {
      setIsLoading(false);
    }
  ...
  // Get subject color based on course ID
  const getSubjectColor = (courseId: number) => {
    switch(courseId) {
      case 7: return '#3b82f6'; // Maths - Blue
      case 8: return '#ef4444'; // Physics - Red
      case 9: return '#10b981'; // Chemistry - Green
  ...
  const handleCourseClick = (courseId: number) => {
    if (courseId === 9) { // JEE Chemistry
      navigate(`/courses/${courseId}/sections`);
    } else { // JEE Mathematics (7) and JEE Physics (8)
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Loading JEE courses...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">JEE Preparation</h1>
          <p className="text-gray-600 dark:text-gray-300">Complete preparation for JEE Main & Advanced - All courses at ₹99/-</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">JEE Courses</p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-yellow-400 to-orange-400 text-white rounded-xl p-4 mb-8 flex items-center justify-center gap-3">
          ...
          <span className="font-semibold">All JEE courses at just ₹99/- each! Limited time offer.</span>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
          ...
          <div>
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search JEE courses..."
                value={searchTerm}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCourses.length > 0 ? (
            ...
            <div className="col-span-full text-center py-16 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">No JEE courses found</h3>
