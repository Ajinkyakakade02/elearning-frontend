...
interface NEETTopicsPageProps {
  darkMode: boolean;
  setDarkMode: (value: boolean) => void;
}

const NEETTopicsPage: React.FC<NEETTopicsPageProps> = ({ darkMode, setDarkMode }) => {
  ...
  const validQuizId = quizId || '3'; // Default to NEET quiz (ID 3)
  ...
  const fetchTopics = async () => {
    ...
    try {
      ...
      if (fetchedTopics && fetchedTopics.length > 0) {
        ...
        // Mock NEET topics as fallback
        const mockTopics: TopicQuiz[] = [
          {
            id: 'neet-biology',
            title: 'Biology',
            description: 'Botany & Zoology: Human Physiology, Genetics, Ecology, Biotechnology, Cell Biology',
            questionCount: 60,
            timeLimit: 60,
            difficulty: 'Medium',
            icon: '🧬',
      ...
      console.error('Failed to fetch NEET topics:', error);
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Loading NEET topics...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">NEET Preparation Topics</h1>
          <p className="text-gray-600 dark:text-gray-300">Choose a subject to test your knowledge for NEET medical entrance exam</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex items-center gap-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white">12.3k</h3>
            ...
            filteredTopicsList.map((topic) => (
              ...
              >
                ...
                >
                  ...
                  <div 
                    className={`inline-block px-3 py-1 rounded-full text-xs font-semibold text-white ${getDifficultyBgColor(topic.difficulty)}`}
                  >
                    {topic.difficulty}
                  </div>
                </div>
