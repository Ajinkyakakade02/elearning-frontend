...
const IndianGeographyPage: React.FC<IndianGeographyPageProps> = ({ darkMode, setDarkMode }) => {
  ...
  const fetchLessons = async () => {
    ...
    try {
      ...
      // Filter for Indian Geography lessons (IDs 811-815)
      const geographyLessons = allLessons.filter(lesson => 
        lesson.id >= 811 && lesson.id <= 815
      );
      
      console.log('Geography lessons:', geographyLessons);
      
      // Sort by ID
      geographyLessons.sort((a, b) => a.id - b.id);
      
      setLessons(geographyLessons);
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-3">
            <FaMountain className="text-5xl" style={{ color: '#10b981' }} />
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Indian Geography</h1>
          </div>
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Complete Indian Geography for UPSC Prelims - Physical, Climate, Drainage, Agriculture, Resources
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 max-w-4xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex items-center gap-4">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center text-white text-2xl" style={{ background: '#10b981' }}>
              <FaBook />
            </div>
            <div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 max-w-4xl mx-auto">
          <div className="mb-4 text-sm text-gray-600 dark:text-gray-400">
            {lessons.length} lessons in Indian Geography
          </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className="text-xl mt-1" style={{ color: isLocked ? undefined : '#10b981' }}>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {lesson.isPreview && (
                          <span className="px-2 py-1 text-white text-xs font-semibold rounded-full whitespace-nowrap" style={{ background: '#10b981' }}>
                            FREE PREVIEW
                          </span>
                        )}
                      </div>
...
export default IndianGeographyPage;