...
interface CSATSectionsPageProps {
  darkMode: boolean;
  setDarkMode: (value: boolean) => void;
}

const CSATSectionsPage: React.FC<CSATSectionsPageProps> = ({ darkMode, setDarkMode }) => {
  ...
  const sections = [
    {
      ...
      description: 'Master comprehension passages, vocabulary, and grammar for CSAT',
      icon: '📖',
      color: '#3b82f6',
      lessonCount: 2,
      duration: '3 hours',
    ...
    },
    {
      ...
      description: 'Syllogisms, puzzles, blood relations, directions, and more',
      icon: '🧩',
      color: '#10b981',
      lessonCount: 4,
      duration: '5 hours',
    ...
    },
    {
      ...
      description: 'Percentages, ratio, time & work, number system, and more',
      icon: '🧮',
      color: '#f59e0b',
      lessonCount: 3,
      duration: '4 hours',
    ...
    },
    {
      ...
      description: 'Tables, graphs, pie charts, and data analysis',
      icon: '📊',
      color: '#8b5cf6',
      lessonCount: 2,
      duration: '2.5 hours',
    ...
    },
    {
      ...
      description: 'Decision making and problem solving for CSAT',
      icon: '⚖️',
      color: '#ec4899',
      lessonCount: 1,
      duration: '1.5 hours',
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">CSAT</h1>
          <p className="text-gray-600 dark:text-gray-300">Civil Services Aptitude Test (Paper II) - Complete Preparation - All at ₹99/-</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-400 to-orange-400 text-white rounded-xl p-4 mb-8 flex items-center justify-center gap-3">
          ...
          <span className="font-semibold">All CSAT topics at just ₹99/- each! Complete CSAT for ₹{totalBundleValue}/-</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sections.map((section) => (
            <div 
              ...
              onClick={() => navigate(`/courses/13/csat/${section.id}`)}
            >
              {/* Topic Header */}
              <div 
...
export default CSATSectionsPage;