...
interface EssayOptionalSectionsPageProps {
  darkMode: boolean;
  setDarkMode: (value: boolean) => void;
}

const EssayOptionalSectionsPage: React.FC<EssayOptionalSectionsPageProps> = ({ darkMode, setDarkMode }) => {
  ...
  const sections = [
    {
      id: 'essay-writing',
      title: 'Essay Writing',
      description: 'Master essay writing techniques, structure, and practice for UPSC Mains',
      icon: <FaPenFancy />,
      color: '#8b5cf6',
      lessonCount: 7,
      duration: '9 hours',
      ...
      topics: [
        ...
        'Conclusion & Quote Integration',
        'Philosophical Essays',
        'Social Issues Essays',
        'Economic Topics Essays',
        'Political & Environmental Essays'
      ]
    },
    {
      id: 'optional-subject',
      title: 'Optional Subject',
      description: 'Strategy, answer writing, and practice for your chosen optional subject',
      icon: <FaBookOpen />,
      color: '#ec4899',
      lessonCount: 7,
      duration: '9 hours',
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">Essay & Optional</h1>
          <p className="text-gray-600 dark:text-gray-300">Complete preparation for Essay paper and Optional subject - All at ₹99/-</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-400 to-orange-400 text-white rounded-xl p-4 mb-8 flex items-center justify-center gap-3">
          ...
          <span className="font-semibold">All sections at just ₹99/- each! Complete Essay & Optional for ₹{totalBundleValue}/-</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {sections.map((section) => (
            <div 
              ...
              onClick={() => navigate(`/courses/13/essay-optional/${section.id}`)}
            >
              {/* Section Header */}
              <div 
...
export default EssayOptionalSectionsPage;